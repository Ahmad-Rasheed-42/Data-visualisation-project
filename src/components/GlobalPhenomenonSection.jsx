...
import { Moon, Stars, Compass } from 'lucide-react';
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center relative z-10 px-12 py-20 overflow-hidden">
      ...
      <motion.div 
        ...
        className="w-full max-w-5xl h-[60vh] bg-magical-midnight/70 rounded-xl p-6 relative overflow-hidden border border-magical-gold/20 backdrop-blur-md z-20 shadow-[0_0_50px_rgba(11,19,43,0.8)]"
      >
